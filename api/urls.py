...
from .controllers.sentiment_filter import SentimentFilter
from .controllers.comment import Comment
from .controllers.comment_filter import CommentFilter
...
urlpatterns = [
	...
	path('getsentiments/', csrf_exempt(SentimentFilter.as_view())),
	path('comment/<id>/', csrf_exempt(Comment.as_view())),
	path('comment/', csrf_exempt(Comment.as_view())),
	path('getcomments/', csrf_exempt(CommentFilter.as_view())),
